...
## テスト戦略
TDD・テストピラミッド・Property-Based Testing・カバレッジ基準の詳細は [`ai/rules/TESTING_STRATEGY.md`](ai/rules/TESTING_STRATEGY.md) を参照してください。
全ての機能実装は Red-Green-Refactor サイクルに従い、カバレッジ 80% 以上を維持してください。
